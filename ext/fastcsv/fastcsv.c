...
#line 301 "ext/fastcsv/fastcsv.c"
	{
	cs = raw_parse_start;
	ts = 0;
	te = 0;
...
#line 403 "ext/fastcsv/fastcsv.rl"
...
#line 371 "ext/fastcsv/fastcsv.c"
	{
	short _widec;
	if ( p == pe )
		goto _test_eof;
...
#line 1 "NONE"
	...
	goto st4;
tr5:
#line 50 "ext/fastcsv/fastcsv.rl"
	{
    if (p == ts) {
...
#line 65 "ext/fastcsv/fastcsv.rl"
	{
...
#line 151 "ext/fastcsv/fastcsv.rl"
	{te = p;p--;}
	goto st4;
tr44:
#line 151 "ext/fastcsv/fastcsv.rl"
...
#line 1 "NONE"
	{ts = p;}
#line 756 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
...
st5:
	if ( ++p == pe )
		goto _test_eof5;
case 5:
#line 864 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(1152 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
st6:
	if ( ++p == pe )
		goto _test_eof6;
case 6:
#line 1182 "ext/fastcsv/fastcsv.c"
	goto tr37;
tr4:
#line 1 "NONE"
	{te = p+1;}
...
st7:
	if ( ++p == pe )
		goto _test_eof7;
case 7:
#line 1467 "ext/fastcsv/fastcsv.c"
	if ( (*p) == 10 )
		goto tr38;
	goto tr37;
tr27:
...
st8:
	if ( ++p == pe )
		goto _test_eof8;
case 8:
#line 1509 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(1152 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
st2:
	if ( ++p == pe )
		goto _test_eof2;
case 2:
#line 1559 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
...
#line 138 "ext/fastcsv/fastcsv.rl"
 (*p) == quote_char  ) _widec += 256;
	...
	goto tr0;
tr11:
#line 61 "ext/fastcsv/fastcsv.rl"
	{
...
st3:
	if ( ++p == pe )
		goto _test_eof3;
case 3:
#line 1617 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(1152 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
st9:
	if ( ++p == pe )
		goto _test_eof9;
case 9:
#line 1980 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
st10:
	if ( ++p == pe )
		goto _test_eof10;
case 10:
#line 2313 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
st11:
	if ( ++p == pe )
		goto _test_eof11;
case 11:
#line 2620 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(128 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
st12:
	if ( ++p == pe )
		goto _test_eof12;
case 12:
#line 2674 "ext/fastcsv/fastcsv.c"
	_widec = (*p);
	_widec = (short)(1152 + ((*p) - -128));
	if ( 
#line 138 "ext/fastcsv/fastcsv.rl"
...
#line 464 "ext/fastcsv/fastcsv.rl"
